...
<div class="content pb-0">
    ...
    <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
        <div>
            <h4 class="mb-0">@yield('subTitle')</h4>
        </div>
        <div class="gap-2 d-flex align-items-center flex-wrap">
            <div class="avatar-list-stacked me-2">
                <a href="#" class="avatar avatar-rounded border bg-white p-1 d-inline-flex align-items-center justify-content-center">
                    <img class="w-auto h-auto img-fluid" src="{{ asset('admin_assets/assets/img/company/company-09.svg')}}" alt="img">
                </a>
                <a href="#" class="avatar avatar-rounded border bg-white p-1 d-inline-flex align-items-center justify-content-center">
                    <img class="w-auto h-auto img-fluid" src="{{ asset('admin_assets/assets/img/company/company-10.svg')}}" alt="img">
                </a>
                <a href="#" class="avatar avatar-rounded border bg-white p-1 d-inline-flex align-items-center justify-content-center">
                    <img class="w-auto h-auto img-fluid" src="{{ asset('admin_assets/assets/img/company/company-01.svg')}}" alt="img">
                </a>
                <a href="#" class="avatar avatar-rounded border bg-white p-1 d-inline-flex align-items-center justify-content-center">
                    <img class="w-auto h-auto img-fluid" src="{{ asset('admin_assets/assets/img/company/company-02.svg')}}" alt="img">
                </a>
                <a href="#" class="avatar avatar-rounded border bg-white p-1 d-inline-flex align-items-center justify-content-center">
                    <img class="w-auto h-auto img-fluid" src="{{ asset('admin_assets/assets/img/company/company-11.svg')}}" alt="img">
                </a>
            ...
            <a href="javascript:void(0);" class="btn btn-icon btn-outline-light shadow" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Collapse" data-bs-original-title="Collapse" id="collapse-header"><i
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="custom-card-icon">
                        <div class="avatar avatar-rounded avatar-lg bg-primary-gradient-100 position-absolute top-0 end-0">
                            <img src="{{ asset('admin_assets/assets/img/icons/revenue-icon.svg')}}" alt="icon" class="img-fluid w-auto h-auto">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="custom-card-icon">
                        <div class="avatar avatar-rounded avatar-lg bg-info-gradient-100 position-absolute top-0 end-0">
                            <img src="{{ asset('admin_assets/assets/img/icons/deal-icon.svg')}}" alt="icon" class="img-fluid w-auto h-auto">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body position-relative">
                    ...
                    <div class="custom-card-icon">
                        <div class="avatar avatar-rounded avatar-lg bg-pink-gradient-100 position-absolute top-0 end-0">
                            <img src="{{ asset('admin_assets/assets/img/icons/conversion-icon.svg')}}" alt="icon" class="img-fluid w-auto h-auto">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="d-flex alig-items-center gap-2">
                        <div class="avatar-list-stacked avatar-group-sm">
                            <span class="avatar avatar-rounded">
                                <img class="border border-white" src="{{ asset('admin_assets/assets/img/profiles/avatar-03.jpg')}}"
                                    alt="img">
                            </span>
                            <span class="avatar avatar-rounded">
                                <img class="border border-white" src="{{ asset('admin_assets/assets/img/profiles/avatar-05.jpg')}}"
                                    alt="img">
                            </span>
                            <span class="avatar avatar-rounded">
                                <img class="border border-white" src="{{ asset('admin_assets/assets/img/profiles/avatar-01.jpg')}}"
                                    alt="img">
                            </span>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-sm-center justify-content-between gap-2 flex-sm-row flex-column mb-3">
                        <div class="d-flex align-items-center">
                            <a href="company-details.html" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/company-icon-01.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                                <p class="fw-medium text-truncate mb-1 fs-14"><a href="company-details.html">NovaWave LLC</a></p>
                    ...
                    <div class="d-flex align-items-sm-center justify-content-between gap-2 flex-sm-row flex-column mb-3">
                        <div class="d-flex align-items-center">
                            <a href="company-details.html" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/company-icon-03.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                    ...
                    <div class="d-flex align-items-sm-center justify-content-between gap-2 flex-sm-row flex-column mb-3">
                        <div class="d-flex align-items-center">
                            <a href="company-details.html" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/company-icon-04.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                                <h6 class="fw-medium text-truncate mb-1 fs-14"><a
                    ...
                    <div class="d-flex align-items-sm-center justify-content-between gap-2 flex-sm-row flex-column mb-3">
                        <div class="d-flex align-items-center">
                            <a href="company-details.html" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/company-icon-02.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                                <h6 class="fw-medium text-truncate mb-1 fs-14"><a
                    ...
                    <div class="d-flex align-items-sm-center justify-content-between gap-2 flex-sm-row flex-column mb-3">
                        <div class="d-flex align-items-center">
                            <a href="company-details.html" class="avatar avatar-md border rounded-circle flex-shrink-0">
                                <img src="{{ asset('admin_assets/assets/img/icons/company-icon-05.svg')}}" class="img-fluid w-auto h-auto" alt="img">
                            </a>
                            <div class="ms-2 flex-fill">
                                <h6 class="fw-medium text-truncate mb-1 fs-14"><a
            ...
            <div class="card flex-fill">
                <div class="card-body">
                    ...
                    <div class="progress-stacked progress-md bg-white gap-1 mb-3">
                        <div class="progress-bar bg-success rounded overflow-hidden" role="progressbar" style="width: 30%" aria-valuenow="10" aria-valuemin="0" aria-valuemax="100">
                        </div>
                        <div class="progress-bar bg-secondary rounded overflow-hidden" role="progressbar" style="width: 35%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                        </div>
                        <div class="progress-bar bg-purple rounded overflow-hidden" role="progressbar" style="width: 25%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100">
                        </div>
                        <div class="progress-bar bg-danger rounded overflow-hidden" role="progressbar" style="width: 10%" aria-valuenow="20" aria-valuemin="0" aria-valuemax="100">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="p-2 d-flex align-items-center justify-content-between border-bottom">
                            <p class="text-dark d-flex align-items-center mb-0"><i class="ti ti-circle-filled text-secondary fs-8 me-1"></i>Pending Deals
                            </p>
