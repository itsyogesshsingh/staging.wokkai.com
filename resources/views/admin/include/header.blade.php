        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="index.html" class="logo">
                ...
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{ asset('admin_assets/assets/img/logo.svg')}}" alt="logo"></span>
                <span class="logo-sm"><img src="{{ asset('admin_assets/assets/img/logo-small.svg')}}" alt="small logo"></span>
                </span>

                <!-- Logo Dark -->
                <span class="logo-dark">
                    <span class="logo-lg"><img src="{{ asset('admin_assets/assets/img/logo-white.svg')}}" alt="dark logo"></span>
                </span>
            </a>
        ...
        <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                        ...
                        <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                            ...
                            <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
                                <div class="d-flex">
                                    <div class="me-2 position-relative flex-shrink-0">
                                        <img src="{{ asset('admin_assets/assets/img/users/user-01.jpg')}}" class="avatar-md rounded-circle" alt="Img">
                                    </div>
                            ...
                            <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
                                <div class="d-flex">
                                    <div class="me-2 position-relative flex-shrink-0">
                                        <img src="{{ asset('admin_assets/assets/img/users/user-12.jpg')}}" class="avatar-md rounded-circle" alt="Img">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
                                <div class="d-flex">
                                    <div class="me-2 position-relative flex-shrink-0">
                                        <img src="{{ asset('admin_assets/assets/img/profiles/avatar-12.jpg')}}" class="avatar-md rounded-circle" alt="Img">
                                    </div>
                                    <div class="flex-grow-1">
                            ...
                            <div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
                                <div class="d-flex">
                                    <div class="me-2 position-relative flex-shrink-0">
                                        <img src="{{ asset('admin_assets/assets/img/profiles/avatar-08.jpg')}}" class="avatar-md rounded-circle" alt="Img">
                                    </div>
                                    <div class="flex-grow-1">
                                        <p class="mb-0 fw-medium text-dark">Ann McClure</p>
                                        <p class="mb-1 text-wrap">mentioned you in <span class="fw-medium text-dark">Bug Fix Review - Task #432</span></p>
                                        <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative" data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ asset('admin_assets/assets/img/users/user-40.jpg')}}" width="38" class="rounded-1 d-flex" alt="user-image">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                    <div class="d-flex align-items-center bg-light rounded-3 p-2 mb-2">
                        <img src="{{ asset('admin_assets/assets/img/users/user-40.jpg')}}" class="rounded-circle" width="42" height="42" alt="Img">
                        <div class="ms-2">
                    ...
                    <div class="pt-2 mt-2 border-top">
                        <a  href="javascript:void(0);" onclick="event.preventDefault(); logout();" class="dropdown-item text-danger">
