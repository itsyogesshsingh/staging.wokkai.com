<x-layouts.admin>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        {{-- @if(auth()->user()->hasPermissionSlug('add_permission')) --}}
                                ...
                                <table class="table table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> <span style="font-weight: 600;">{{ trim(($row->name ?? 'N/A')) }}</span></td>
                                            <td>Admin</td>
                                            <td>Admin</td>
                                            <td>15 May</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropdown table-action">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" style="">
                                                        @if(auth()->user()->hasPermissionSlug('edit_permission'))
                                                        ...
                                                        @if(auth()->user()->hasPermissionSlug('delete_permission'))
    ...
    <div class="offcanvas offcanvas-end offcanvas-large" tabindex="-1" id="offcanvasRight" data-bs-backdrop="static" data-bs-keyboard="false">
        ...
        <div class="offcanvas-body">
            <form action="{{ route('permission.store') }}" id="addData" method="post">
                @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select select2" id="module_id" name="module_id">
        ...
        <div class="modal-dialog modal-dialog-centered modal-sm rounded-0">
            <div class="modal-content rounded-0">
                <div class="modal-body p-4 text-center position-relative">
                    ...
                    <p class="mb-3">Are you sure you want to remove this record?.</p>
    ...
    <script>
        ...
        */
        ...
        $(document).ready(function () {
            ...
            let deleteId = null;
            const deleteRoute = "{{ route('permission.delete', ':id') }}";

            const routes = {
                edit: "{{ route('permission.edit', ':id') }}",
                update: "{{ route('permission.update', ':id') }}",
                delete: "{{ route('permission.delete', ':id') }}",
                index: "{{ route('permission.index') }}"
            };
            ...
            $(document).on('click', '.edit-item-btn', function () {
                let id = $(this).data('id');
                const editUrl = "{{ route('permission.edit', ':id') }}".replace(':id', id);
                const updateUrl = "{{ route('permission.update', ':id') }}".replace(':id', id);

                $('#addData').attr('action', updateUrl);
                $('input[name="_method"]').val('PUT');
                $('#offcanvasRightLabel').text('Edit @yield("subTitle")');
                $('#btnUpdate').text('Update');
                $('#table-loader').addClass('active');

                $.get(editUrl, function (res) {
                    let permissionData = res.data?.data || res.data || res;

                    $('#permission_name').val(permissionData.permission_name || permissionData.name);

                    if(permissionData.module_id) {
                        var option = new Option(
                            permissionData.module?.module_name || 'N/A',
                            permissionData.module_id,
                            true,
                            true
                        );
                        $('#module_id').append(option).trigger({
                            type: 'change.select2',
                            triggeredByCode: true
                        });
                    }

                    $('#status').val(permissionData.status).trigger('change');
                    $('#table-loader').removeClass('active');
                }).fail(function() {
                    $('#table-loader').removeClass('active');
                });
            ...
            $('#offcanvasRight').on('hidden.bs.offcanvas', function () {
                ...
                $('#addData').attr('action', "{{ route('permission.store') }}");
